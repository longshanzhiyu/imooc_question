...
function default_1(config) {
    ...
    const { alias = util_1.emptyObj, entry = util_1.emptyObj, output = util_1.emptyObj, sourceRoot = '', outputRoot, publicPath = '', staticDirectory = 'static', chunkDirectory = 'chunk', dllDirectory = 'lib', dllEntry = {
